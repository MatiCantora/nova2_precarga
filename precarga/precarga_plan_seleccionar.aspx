...
<% 
    ...
    If modo = "A" Then
        ...
        Try
            ...
            Dim cmd As New nvFW.nvDBUtiles.tnvDBCommand("rm_cr_cambiar_plan_v2", ADODB.CommandTypeEnum.adCmdStoredProc)
...
<head>
    ...
    function btnBuscarPLanes_onclick(nro_plan) {
        ...
        strWhere += "<socio type='sql'>dbo.rm_tabla_socio_nuevo (nroTabla," + nro_docu + "," + tipo_docu + ",'" + sexo + "') = 1</socio>"
