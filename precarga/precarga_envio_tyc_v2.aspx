...
<% 
    ...
    'strSql= "select * from verCreditos where nro_credito=" & crparam.toString
    Dim rs2 As ADODB.Recordset = nvDBUtiles.DBOpenRecordset("select nro_tabla from verCreditos where nro_credito=" & crparam.toString)
    ...
    Me.contents("filtroValidacion") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verTabla_tipo_validacion_parametro'><campos>id_validacion_tipo as id,validacion_tipo as [campo]</campos><orden></orden><filtro><nro_tabla type='igual'>" & nro_tabla & "</nro_tabla><tiene_permiso type='igual'>1</tiene_permiso></filtro></select></criterio>")
