...
<%
    ...
    If (accion = "updatecobro") Then
        ...
        Else
            Err.numError = -1
            Err.mensaje = "no se definió el cobro"
        End If
    ...
    Me.contents.Add("cuentas", nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verEntidad_bco_ctas'><campos>*</campos><orden></orden><filtro><not><cbu type='igual'>''</cbu></not></filtro></select></criterio>"))
             ...
             oXML.onComplete = function ()
                           {
                            ...
                            if (objXML.loadXML(strXML)){
                                ...
                                var mensaje=''
                                if(numError==0){
                                cuentavalida =XMLText(selectSingleNode('params/cuentavalida', oNode))
                                valida=(cuentavalida=='1')?1:0
                                }else{
