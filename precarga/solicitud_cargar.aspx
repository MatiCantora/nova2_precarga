    ...
    <script type="text/javascript" language="javascript" class="table_window">
        ...
        function guardar() {
            ...
            if (campos_defs.get_value("fe_naci") == '') {
                alert("Complete la fecha de nacimiento por favor")
                $('fe_naci').focus()
                return
            }

            if (campos_defs.get_value('dni') == '') {
                alert("Complete el número de documento del socio")
                $('dni').focus()
                return
            }
            ...
            if (campos_defs.get_value('id_estado_civil') == '') {
                alert("Complete el estado civil por favor")
                return
            }
            ...
            if (campos_defs.get_value('apellido_materno') == '' && nro_banco_cr == '800') { //control solo cuando es banco voii
                alert("Complete el apellido materno por favor")
                $('apellido_materno').focus()
                return
            }

            if (campos_defs.get_value('calle') == '') {
                alert("Ingrese calle por favor ")
                $('calle').focus()
                return
            }

            if (campos_defs.get_value('numero') == '') {
                alert("Ingrese numero de calle por favor ")
                $('numero').focus()
                return
            }
            ...
            if (campos_defs.get_value('postal') == '') {
                alert("Ingrese el codigo postal por favor ")
                $('postal').focus()
                return
            }
...
<body onload="return window_onload()" onresize="return window_onresize()" style="height: 100%; background-color: white; -webkit-text-size-adjust: none; overflow: auto;">
    ...
    <div style="overflow: auto; -webkit-overflow-scrolling: touch; overflow-x: hidden;" id="containerDiv">
        <table class="tb1" id="tbResultado" style="width: 100%; white-space: nowrap;">
            <tr>
                <td class="Tit1" style="text-align: center;"><b>Datos Personales</b></td>
            </tr>
            <tr>
                <td>
        ...
        <table class="tb1" id="tbContactos" style="width: 100%; white-space: nowrap;">
            <tr>
                <td class="Tit1" style="text-align: center;"><b>Contactos Telefónicos</b></td>
            </tr>            
            <tr>
                <td>
        ...
        <table class="tb1" id="tbSolicitud" style="width: 100%; white-space: nowrap;">            
            <tr>
                <td style="font-size: smaller; color: #4C66B7">*Campos obligatorios</td>
            </tr>
        </table>
        <table class="tb1">
            <tr>
