    ...
    Select Case modo.ToUpper
        ...
        Case "S"    'Generar Solicitud
            ...
            Try
                ...
                Dim cmd As New nvFW.nvDBUtiles.tnvDBCommand("rm_cr_solicitud_v2", ADODB.CommandTypeEnum.adCmdStoredProc)
    ...
    function CargarSocio_Creditos(filtros,bloqueo)
    {
        ...
        rsC.onComplete = function (rsC) {
            ...
            while (!rsCS.eof()) {
                i++
                Creditos[i] = {}
                Creditos[i]['nro_credito'] = rsCS.getdata('nro_credito')
                Creditos[i]['nro_banco'] = rsCS.getdata('nro_banco')
