...
<%
    ...
    Dim a As trsParam = New trsParam(dic)

    Dim b As trsParam = New trsParam({"param1", "param2", "param3"}, {1, 4, 5})
    'Stop
...
<head>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function exportar_ej1() { 
            ...
            var filtroWhere = "" //"<criterio><select PageSize='5' AbsolutePage='2' ><filtro></filtro><orden>estado</orden></select></criterio>" //"<criterio><select><filtro><estado>'G'</estado></filtro></select></criterio>" //
            //filtroWhere =   "<criterio><select ><filtro><estado>%pestado%</estado></filtro><orden>estado</orden></select></criterio>"
            //VistaGuardada = "vg1"
            var params = "<criterio><params pestado=\"'T'\" /></criterio>"
