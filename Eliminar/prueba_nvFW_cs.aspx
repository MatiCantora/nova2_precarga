<%@ Page Language="C#" AutoEventWireup="false" CodeFile="prueba_nvFW_cs.cs" Inherits="prueba_nvFW_cs" EnableSessionState="True" %>
<%


    //this.contents permite transferir datos estructurados al browser
    //Pueden ser datos simples integer, string, double, etc o complejos como el trsParam o cualquier tipo se se pueda serializar a JSON
    ...
    trsParam a = new trsParam();
    a["algo"] = "prueba";
    a["algo2"] = "prueba2";
    this.contents["dato6"] = a;

    trsParam b = new trsParam(new string[] { "param1", "param2", "param3" }, new object[] { 1, 4, 5 });
    this.contents["dato7"] = b;

    //Enviar permisos al browser
    this.addPermisoGrupo("permiso_grupo");


    nvSession.Contents["algo"] = "Valor string";
    //this.contents["filtroXML_exportar_ej1"] = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='estado'><campos>*, %nvSession['algo']?(varchar):Hola Mundo%</campos><filtro></filtro></select></criterio>");
...
<head>
    ...
    <script type="text/javascript">
        ...
        function window_onload() {
            ...
            //$("spnTitulo").innerHTML = nvFW.pageContents.dato1
            //$("spnTitulo").innerHTML += "<br/>" + nvFW.pageContents.dato2.toString()
            //$("spnTitulo").innerHTML += "<br/>" + nvFW.pageContents.dato6.algo
            //$("spnTitulo").innerHTML += "<br/>" + nvFW.pageContents.dato7.param1
            //$("spnTitulo").innerHTML += "<br/>"
            //$("spnTitulo").innerText += nvFW.pageContents.filtroXML_exportar_ej1
            window_onresize()
        }
    ...
    <script type="text/javascript" language="javascript">
        ...
        function exportar_ej1() { 
            ...
            //Destino un IFRAME
            //select * from estados
            var filtroXML = "" //"<criterio><select PageSize='5' AbsolutePage='2' vista='estado'><campos>*</campos><filtro></filtro></select></criterio>"
            var filtroWhere = "" // "<criterio><select PageSize='5' AbsolutePage='2'><orden>estado</orden><filtro><estado>'A'</estado></filtro></select></criterio>"
            var params = ""
            //filtroWhere = "<criterio><select PageSize='5' AbsolutePage='2' ><filtro></filtro><orden>estado</orden></select></criterio>"
    
            filtroXML = nvFW.pageContents.filtroXML_exportar_ej1
            //var filtroWhere = "<criterio><select><filtro><estado>'G'</estado></filtro></select></criterio>" //

            //filtroWhere =   "<criterio><select ><filtro><estado>%pestado%</estado></filtro><orden>estado</orden></select></criterio>"
            //VistaGuardada = "vg1"
            ...
            //var filtroWhere = "<criterio><select><orden>estado</orden><filtro><estado>'A'</estado></filtro></select></criterio>"

            var filtroXML = "<criterio><select vista='estado'><campos>*</campos><filtro><estado>%pestado%</estado></filtro></select></criterio>"
...
//        win.document.body.innerHTML = ""
     ...
     , ContentType: "application/vnd.ms-excel"
      ...
      function exportar_ej15() {
         ...
         filtroXML = "<criterio><select vista='estado' PageSize='3' AbsolutePage='1' ><campos>*</campos></select></criterio>"
         nvFW.exportarReporte({
         filtroXML: filtroXML
        , path_xsl: "report/ejemplos/HTML_paginacion.xsl"
        , salida_tipo: "adjunto"
     ...
     function exportar_ej16() {
         ...
         var filtroXML = "<criterio><select vista='estado' PageSize='5' AbsolutePage='1' cacheControl='session' expire_minutes='60'><campos>*</campos></select></criterio>"
         //var filtroXML = "<criterio><select cacheID='25' PageSize='3' AbsolutePage='2'></criterio>"
         var filtroXML = "<criterio><select vista='estado' PageSize='5' AbsolutePage='1' cacheControl='session' expire_minutes='1' ><campos>*</campos></select></criterio>"
         nvFW.exportarReporte({
         filtroXML: filtroXML
        , path_xsl: "report/ejemplos/HTML_paginacion.xsl"
        , salida_tipo: "adjunto"
...
<body  style="width: 100%; height: 100%; overflow: auto" onload="return window_onload()"    onresize="return window_onresize()">
    ...
    <table class="tb1">
        <%-- <tr class="tbLabel0">
            <td>
               <span id="spnTitulo" style="font-weight:bold;"></span>
            </td>
        </tr>--%>
        <tr class="tbLabel0">
            <td>
    ...
    <table class="tb1">
        <tr>
            ...
            <td style="" >
               <%
                   nvFW.tnvCampo_def miCampo_def = new nvFW.tnvCampo_def();
                   miCampo_def.campo_def = "miCampo_def";
                   miCampo_def.nro_campo_tipo = nvFW.enumnvCampo_def_tipos.combo_simple;
