    ...
    <xsl:template match="z:row">
        ...
        <tr id="tr_ver{$pos}">
            <td style="width: 25px; text-align: center;">
                <img alt="Seleccionar" src="/FW/image/icons/seleccionar.png" style="cursor: pointer;" title="Seleccionar a {@cliape}, {@clinom}" onclick="return cargarDatosCliente({$cuit})" />
            </td>
