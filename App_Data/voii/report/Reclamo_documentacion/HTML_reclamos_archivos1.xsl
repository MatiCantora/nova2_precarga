      ...
      <body onload="window_onload()" onresize="window_onresize()" style="width:100%;overflow:auto;margin-bottom:0px;padding-bottom:0px" hover="background :rgba(grey, 0.5);">
        <table class="tb1" id="tbCabe" >
          <tr class="tbLabel">
            ...
            <td style='width:76px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Tipo', 'false', 'nro_archivo_id_tipo' + '-' + 'id_tipo')
              </script>
            </td>
            <td style='width:145px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Definición', 'false', 'def_archivo')
              </script>
            </td>
            <td style='width:245px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Documento', 'false', 'archivo_descripcion')
              </script>
            </td>
            <td style='width:92px;text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Obligatorio', 'false', 'requerido')
              </script>
            </td>
            <td style='width:124px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
            ...
            <td style='width:125px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
            ...
            <td style='width:115px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Oficial Doc.', 'false', 'ofinrodoc')
              </script>
            </td>
            <td style='width:100px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Estado Cli.', 'false', 'tiprel')
              </script>
            </td>
            <td style='width:90px; text-align:center' nowrap='true' table-layout='fixed'>
              <script type="text/javascript">
                campos_head.agregar('Forzado', 'false', 'reclamable')
              </script>
            </td>
            <td style='text-align:center' nowrap='true' table-layout='fixxed'>
              <script type="text/javascript">
