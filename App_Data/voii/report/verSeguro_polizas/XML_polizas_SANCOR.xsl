...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	...
	<![CDATA[
		function limpiar_seguro(cadena)
		{
			var caracter='('
			var i=cadena.indexOf(caracter)
				if(i > 0)
				{		
				cadena = cadena.substring(1, i-1)
				}
			return cadena
		}
	]]>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 <DocumentProperties xmlns="urn:schemas-microsoft-com:office:office">
  ...
  <LastSaved>2014-07-15T18:55:10Z</LastSaved>
 ...
 <Worksheet ss:Name="Polizas Sancor">
