       ...
       <script type="text/javascript">
         ...
         <![CDATA[
                function onload() {
                   ...
                   cargarCircuito = parent.cargarCircuito
        ...
        <nav class="tab">
          <xsl:choose>
            <xsl:when test="@hijos > 0">
              <img id="showframe{$frameHijosId}" src="../../FW/image/icons/mas.gif" style="cursor:pointer; float: left;" title="Ver Hijos" onclick="verHijos{$frameHijosId}()">
                <xsl:attribute name="onclick">
