            ...
            <div id="contenedor" style="width: 100%; overflow: auto;">
              <table class="tb1">
                <tr class="tbLabel">
                  ...
                  <td style="width: 150px; text-align: center;" nowrap="true">
                    <script>campos_head.agregar('Fecha', 'true', 'fecha')</script>
                  </td>
                  <td style="width: 200px; text-align: center;" nowrap="true">
                  ...
                  <td style="text-align: center; width: 70px;">Moneda</td>
                  <td style="text-align: center; width: 75px; " title="En Espera">ES</td>
                  <td style="text-align: center; width: 75px; " title="Pendiente">PD</td>
                  <td style="text-align: center; width: 75px; " title="Pagado">PG</td>
                  <td style="text-align: center; width: 75px; " title="Anulado">AN</td>
                  <td style="text-align: center; width: 75px; " title="Otros">OT</td>
      ...
      <xsl:when test="$proceso_ant != $proceso or $pos = 1">
        ...
        <table class="tb1 highlightTROver sumar" id="{$proceso}">
          <tr>
            ...
            <td style="width: 75px; text-align: right; color: grey;">
              <xsl:value-of select="format-number(@pago_en_espera, '0.00')" />&#160;
            </td>
            <td style="width: 75px; text-align: right; color: blue;">
              <xsl:value-of select="format-number(@pago_pendiente, '0.00')" />&#160;
            </td>
            <td style="width: 75px; text-align: right; color: green;">
              <xsl:value-of select="format-number(@pago_pagado, '0.00')" />&#160;
            </td>
            <td style="width: 75px; text-align: right; color: red;">
              <xsl:value-of select="format-number(@pago_anulado, '0.00')" />&#160;
            </td>
            <td style="width: 75px; text-align: right;">
              <xsl:value-of select="format-number(@pago_otro, '0.00')" />&#160;
            </td>
            <td style="width: 130px; text-align: right;">
              <b>
                <span id="importe{$proceso}"></span>&#160;
              </b>
            </td>
            <td style="width: 120px; text-align: center;">
              ...
              <img alt="Estado" src="/FW/image/icons/seleccionar.gif" style="cursor: pointer;" title="Cambiar estado al proceso {$proceso}" onclick="parent.cambiarEstado({$proceso}, '{@fecha}', '{@nro_pago_concepto}', '{@pago_concepto}', '{@nombre_operador}', '{@ISO_cod}')" />&#160;
              <img alt="Comentario" src="/FW/image/icons/comentario3.png" style="cursor: pointer;" title="Ver registro de edición" onclick="parent.verComentarios({$proceso})" />
            </td>
          </tr>
        </table>
        ...
        <table class="tb1 detalle{$proceso}" cellspacing="0" cellpadding="0" style="display: none;">
          <tr style="height: 19px;">
            ...
            <!-- solo para "espacear" la sub-tabla -->
            ...
            <td class="Tit4" style="width: 80px; text-align: center;">Tipo Orig.</td>
            ...
            <td class="Tit4" style="width: 80px; text-align: center;">Tipo Dest.</td>
            ...
            <td class="Tit4" style="width: 80px; text-align: center;">Moneda</td>
        ...
        <table class="tb1 highlightTROver detalle{$proceso}" cellspacing="0" cellpadding="0" style="display: none; font-size: 0.85em;">
          <tr style="height: 19px;">
            ...
            <!--<td style="text-align: right; min-width: 90px;">
              ...
              <span class="importe{$proceso}" style="float:right;">
                <xsl:value-of select="format-number(@importe_pago_det, '#.00')" />
              </span>&#160;-->
              <!--$ <span class="importe{$proceso}">
                <xsl:value-of select="format-number(@importe_pago_det, '#.00')" />
