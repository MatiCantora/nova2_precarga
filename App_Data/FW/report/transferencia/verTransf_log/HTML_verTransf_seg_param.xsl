  ...
  <msxsl:script language="javascript" implements-prefix="foo">
	...
	<xsl:template match="/">
        ...
        <tr class="tbLabel">
                    ...
                    <td class="Tit1" style='text-align:center'>
                     <script>
                       campos_head.agregar('Parametro: ', true, 'parametro')
                       campos_head.agregar('Valor', true, 'valor')
                     </script>
                   </td>
                   <td class="Tit1" style='text-align:center;width:3%;'>&#160;-&#160;</td>
                   <td class="Tit1" style='text-align:center;width:3%;'>&#160;-&#160;</td>
                   <td class="Tit1" style='text-align:center;width:3%;'>&#160;-&#160;</td>
        </tr>
 		    </table>
    ...
    <tr>
      ...
      <xsl:if test ="count(/xml/rs:data[z:row/@resumen != '']) > 0">
        ...
        <td>
         <xsl:attribute name='title'><xsl:value-of select="@parametro"/>:&#160;<xsl:value-of select="@valor"/></xsl:attribute>
         <xsl:value-of select="@parametro"/>:&#160;<xsl:value-of select="@valor"/>
        </td>
        <td style="text-align:center; width:3%" >
            <img>
                <xsl:attribute name="onclick">parent.mostrar_transf('<xsl:value-of select="$id_transf_log" />','<xsl:value-of select="@id_transferencia" />','<xsl:value-of select="@nombre" />','<xsl:value-of select="@fe_inicio" />','<xsl:value-of select="@fe_fin" />','<xsl:value-of select="@nombre_operador" />','<xsl:value-of select="@estado" />')</xsl:attribute>
		...
		<td style="text-align:center; width:3%">
			<xsl:choose>
				<xsl:when test='@estado != "finalizado" and @estado != "Pendiente" and @estado != "error"'>
					<img>
						<xsl:attribute name="onclick">parent.finalizar_transf('<xsl:value-of select="$id_transf_log" />','<xsl:value-of select="@operador" />')</xsl:attribute>
