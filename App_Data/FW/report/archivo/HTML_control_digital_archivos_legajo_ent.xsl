  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <script type="text/javascript">
          ...
          var pos = 0
            ...
            function fisicoMasivo() {
                ...
                var desc = ""
                var id = ""
                var tope = document.querySelectorAll('input').length * 8 -1
            console.log(tope)
        ...
        function fisicoMasivo() {
          var child = parent
          parent.parent.fisicoMasivo(pos, child, 1)
        }

        function todosFisisco() {
            var c = 0
            var tope = document.querySelectorAll('input').length * 10 - 10
