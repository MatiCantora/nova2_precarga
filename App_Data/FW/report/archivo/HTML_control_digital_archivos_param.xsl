...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <html>
      <head>
        ...
        function todosFisisco() {
            ...
            var tope = document.querySelectorAll('input').length * 11 - 11
            console.log(tope)
      ...
      <body onload="window_onload()" onresize="window_onresize()" style="width:100%;overflow:auto;margin-bottom:0px;padding-bottom:0px" hover="background :rgba(grey, 0.5);">
        <table class="tb1" id="tbCabe" >
          <tr class="tbLabel">
            <td style='width:2%; padding:0; text-align:center'>
            ...
            <td style='width:8%; text-align:center'>
              <script type="text/javascript">
                campos_head.agregar('Parametro', 'false', 'parametro')
              </script>
            </td>
            <td style='width:8%; text-align:center'>
              <script type="text/javascript">
                campos_head.agregar('Valor', 'false', 'parametro_valor')
              </script>
            </td>
  ...
  <xsl:template match="z:row">
    ...
    <tr>
      ...
      <td style='width:14%'>
        <xsl:attribute name="style">width:14%; cursor:pointer !Important; text-decoration: underline;</xsl:attribute>
        <xsl:attribute name="onclick">
