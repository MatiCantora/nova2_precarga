...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
        ...
        <html onload="return window_onload()" >
            ...
            <body onload="window_onload()" style="width:100%;height:100%;overflow:hidden">
                <table class="tb1" id="tbCabe" >
                    <tr>
                        <td style="text-align: center; " class="Tit1">  Id Parametro </td>
                        <td style="text-align: center; width: 50%" class="Tit1"> Descripción</td>
                        <td style="text-align: center; width: 6%" class="Tit1"> Ver </td>
                    </tr>
                </table>
    ...
    <xsl:template  match="z:row">
        ...
        <tr >
            <td style="text-align: ;"><xsl:value-of  select="@id_param" /></td>
            <td style="text-align: ; width: 50%"><xsl:value-of  select="@param" /></td>
