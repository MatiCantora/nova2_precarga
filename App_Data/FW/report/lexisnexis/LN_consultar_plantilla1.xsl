...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="z:row"  mode="row1">
    ...
    <tr name="dataRow">
      ...
      <td style="align:center; text-align:center; width:3%">
        <img src="../../FW/image/docs/pdf.png" style="cursor:pointer" >
      ...
      <td style="align:center; text-align:center; width:3%">
        ...
        <xsl:if test="@vigente = 'True' ">
          ...
          <img src="../../FW/image/icons/persona_quitar.ico" style="cursor:pointer" >
            <xsl:attribute name="onclick">
              parent.confirm_vigencia('<xsl:value-of select="@nro_consulta"/>')
      ...
      <td style="align:center; text-align:center; width:3%">
        <img src="../../FW/image/icons/persona_editar.ico" style="cursor:pointer" >
          <xsl:attribute name="onclick"> parent.nueva_consuta('<xsl:value-of select="@nombres"/>','<xsl:value-of select="@apellido"/>','<xsl:value-of select="@tipo_docu"/>','<xsl:value-of select="@nro_docu"/>','<xsl:value-of select="@sexo"/>','<xsl:value-of select="@pais"/>','<xsl:value-of select="foo:FechaToSTR(string(@fe_naci))"/>','<xsl:value-of select="@division"/>','<xsl:value-of select="@vigente"/>','True','<xsl:value-of select="@nro_consulta"/>','<xsl:value-of select="@PredefinedSearchName"/>','<xsl:value-of select="@ResultID"/>')
          </xsl:attribute>
        </img>
      </td>
