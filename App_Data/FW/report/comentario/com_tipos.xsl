          ...
          <![CDATA[
              ...
              function onresize() {
                 try{
                   ...
                   var tamanio = (body.getHeight() - 30)>40 ?(body.getHeight() - 30) + "px" : "40 px"; 
                    //console.log(tamanio)
        ...
        <div style="width:100%; text-align:center" id="divCabeceras">
          <table class="tb1 highlightEven highlightTROver scroll " id="header_tbl" name="header_tbl" style="width: 100%;">
            <tr class='tbLabel'>
              ...
              <td  style='width:30%'>Nro Tipo</td>
              <td  style='width:50%'>Descripcion Tipo</td>
            </tr>
          </table>
        </div>
  ...
  <xsl:template match="z:row">
    ...
    <tr>
      <td style='text-align: center;'>
        <input type="checkbox"  name='checked_tipo_{@nro_com_tipo}' id='checked_tipo_{@nro_com_tipo}'>
          <xsl:attribute name="onclick">
            parent.addTipo(this,'<xsl:value-of select="@nro_com_tipo"/>')
          </xsl:attribute>
        </input>
      </td>
      <td>
