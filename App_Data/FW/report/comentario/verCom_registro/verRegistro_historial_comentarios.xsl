...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:include href="..\..\xsl_includes\vb_nvPageXSL.xsl"></xsl:include>
  ...
  <msxsl:script language="vb" implements-prefix="user">
    ...
    <![CDATA[
      ...
      Public function getfiltrosXML() as String
          ...
          Page.contents("verRegistro") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verRegistro'><campos>*</campos><filtro></filtro><orden></orden></select></criterio>")
          Page.contents("verRegistro_estado") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verRegistro'><campos>*</campos><orden>com_prioridad desc, fecha</orden><filtro></filtro></select></criterio>")
					Page.contents("verRegistro_estado_doc") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verRegistro'><campos>*</campos><orden>com_prioridad desc, fecha</orden><filtro></filtro></select></criterio>")
  ...
  <xsl:template match="/">
					...
					function ABMRegistro(nro_entidad,nro_registro)
						...
						if(permitirABM){
                          ...
                          window.top.win = w.createWindow({ className: 'alphacube',
                                      url: '/fw/comentario/ABMRegistro.aspx?nro_entidad=' + nro_entidad + '&nro_registro=' + nro_registro,
	...
	<xsl:template match="z:row">
		...
		<table cellspacing="0" cellpadding="0">
			<tr>
				<td style='text-align: left; FONT-SIZE: 10px; !Important;width: 5%; '>
					<xsl:if test="@Hijos > 0">
            ...
            <img src='/FW/image/comentario/menos.jpg' border='0' align='absmiddle' hspace='1'>
              ...
              <xsl:attribute name='onclick'>return nodo_onclick(<xsl:value-of select='@nro_registro'/>)</xsl:attribute>
				...
				<td style='text-align: left; FONT-SIZE: 10px; !Important; width: 25%; overflow-wrap: break-word'>
          ...
          <b>
            ...
            <xsl:value-of select="@nombre_operador"/>
				...
				<td style="FONT-SIZE: 11px; !Important; text-indent: 5px;overflow-wrap: break-word">
