        ...
        <html>
            <head>
                ...
                <script type="text/javascript" language="javascript">
                    ...
                    /***  Verifica si el operador está "Suscripto" a la referencia  ***/
                    ...
                    /***  Muestra de icono de favorito del menú de diferente color, dependiendo si el operador esta suscripto o no a la referencia buscada  ***/
                    function toggleSus()
                    {
                    ...
                    function verSuscripcionPendiente() {
                        if (tieneSuscripcionPendiente(nro_ref)) {
                            window.top.nvFW.confirm("Ha sido subscripto a la referencia. ¿Desea confirmar la suscripcion?", {
                                width: 300,
                                okLabel: "Aceptar",
                    ...
                    function updateRefOp(nro_ref) {
                        var alert_1 = '',
                            alert_2 = 'No se pudo realizar la operación';
                    ...
                    /***  Abre una ventana/pestaña del navegador, con la información de la versión seleccionada del documento de una referencia ***/
                    function seleccionar_version(ref_doc_version, nro_ref_doc, nro_ref) { 
                        ...
                        nvFW.exportarReporte({
                            ...
                            , nvFW_mantener_origen: true
                            , id_exp_origen: 0
                            , parametros: '<parametros><id_ref_auto>' + id_ref_auto + '</id_ref_auto><app_path_rel>' + app_path_rel + '</app_path_rel></parametros>'
                        })
			        }	
                    ...
                    function version_buscar(referencia, documento) { 
						...
						if (ref_editar == '1') {                           
                            ...
                            win_version_buscar = window.top.nvFW.createWindow({ 
                                url: 'version_buscar.aspx?nro_ref=' + referencia + '&nro_ref_doc='+ documento, 
                                title: '<b>Versiones</b>',
                                minimizable: true,
                                maximizable: false,
                                draggable: true,
                    ...
                    {
                        if (window.top.nvFW.tienePermiso('permisos_referencias', 3) || id_ref_auto) {
                        
                            // Verificar si puede editar la referencia en cuestión. [Permiso #3]: modificar
                            if (!window.top.tienePermisoReferencia(3)) {
                                alert("No posee permiso para editar ésta referencia. Consulte con el Administrador del Sistema.")
                                return false
                            }
                            ...
                            win_referencias_abm = window.top.nvFW.createWindow({
                                ...
                                destroyOnClose: true,
                                onClose: function(){
                                    window.top.abrir_ventana_emergente_OnClose  
                                }
                            });
                            ...
                            window.top.alert('No posee permisos para editar en WIKI. Consulte con el Administrador del Sistema.')
                            return false
                        }
                    }
                        
                    /***  Al presionar el botón favorito del menú:
                    ...
                    ***/
                    ...
                    /***  Abre una nueva ventana con la vista "Actual" o "Resumen" del resultado de la búsqueda, visualizado como PDF  ***/
                    function ref_impresion_pdf(nro_ref, tipo_salida) {
                        window.top.abrir_ventana_emergente('ref_pre_export_pdf.aspx?nro_ref=' + nro_ref + '&tipo_salida=' + tipo_salida, 'Exportar referencia', 'permisos_referencias', 1, 236, 450)
                    }

                    /***  Abre una nueva ventana con la vista "Actual" del resultado de la búsqueda, para Imprimir  ***/
                    ...
                    /***  Abre una nueva ventana con la vista "Completa" del resultado de la búsqueda, para Imprimir  ***/
                    ...
                    {
                        // Chequear que el operador puede administrar los permisos. [Permiso #5] : Administración de permisos
                        if (!window.top.tienePermisoReferencia(5)) {
						...
						window.top.abrir_ventana_emergente('ref_permisos_abm.aspx?nro_ref=' + nro_ref , 'Permisos de Referencia', 'permisos_referencias', 1, 500, 950)
		            }
                    ...
                    function referencia_eliminar(nro_ref) { 
                        if(window.top.nvFW.tienePermiso('permisos_referencias', 2)){
					        window.top.nvFW.confirm('¿Desea eliminar esta referencia?', {
                                width: 300, 
                                onOk: function(win) {
                                    Ref_eliminar(nro_ref);
                                    win.close();
                                }, 
            ...
            <table class="tbDoc_cab" style="width: 100%;">
                <tr nowrap="true">
                    ...
                    <td style="text-align:right; vertical-align:bottom; font-size:13px;">
                        ...
                        <a>
                            <img src='/fw/image/icons/operador.png' border='0' align='absmiddle' hspace='2'></img>
                        </a>
                        <b>
