                ...
                <script type="text/javascript" language="javascript">
                    ...
                    function toggleSus() {
                        if (estaSuscripto(nro_ref)) {
                            $('vMenu_img20').up('td').setStyle({'display':'table-cell'});
                            $('vMenu_img21').up('td').setStyle({'display':'none'});
						}
                        else {
                            $('vMenu_img20').up('td').setStyle({'display':'none'});
                            $('vMenu_img21').up('td').setStyle({'display':'table-cell'});
						}

                        $('vMenu_img20').setStyle({'display': 'inline'});
                        $('vMenu_img21').setStyle({'display': 'inline'});
					}
                    ...
                    function editar_referencia() { 
                        if (window.top.nvFW.tienePermiso('permisos_referencias', 3) || id_ref_auto) {
                            ...
                            window.top.alert('No posee permisos para realizar esta acción. Consulte con el Administrador del Sistema.')
                        }
                    }
                    ...
                    ***/
                    ...
                    function permiso_referencia(nro_ref) { 
		                if (ref_admin == '1')
						    window.top.abrir_ventana_emergente('ref_permisos_abm.aspx?nro_ref=' + nro_ref ,'Permisos de Referencia',undefined,undefined,500,700)
						else
                            window.top.alert('No posee permisos para realizar esta acción. Consulte con el Administrador del Sistema.')
		            }
