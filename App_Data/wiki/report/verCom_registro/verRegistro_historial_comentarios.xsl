...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
					...
					<xsl:comment>
					    ...
					    function nodo_onclick(nro_registro) {
					        var tb = eval('document.all.tbH' + nro_registro),
                                imgG = eval('document.all.imgG' + nro_registro)
					    ...
					    function ABMRegistro(nro_entidad, nro_registro) {						  
                            ...
                            window.top.win = window.top.nvFW.createWindow({
                                        url: 'ABMRegistro.aspx?nro_entidad=' + nro_entidad + '&nro_registro=' + nro_registro,
	...
	<xsl:template match="z:row">
		...
		<table cellspacing="0" cellpadding="0" class="tb1">
			<tr>
				<td style='text-align: left; FONT-SIZE: 10px !Important'>
					<xsl:if test="@Hijos > 0">
                        ...
                        <img src='/FW/image/comentario/menos.gif' border='0' align='absmiddle' hspace='1'>
					...
					<xsl:if test="@Hijos = 0">
					    <img src='/FW/image/comentario/punto.gif' border='0' align='absmiddle' hspace='1'/>
					</xsl:if>
				</td>
