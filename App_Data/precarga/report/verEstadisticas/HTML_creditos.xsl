  ...
  <xsl:output method="html" encoding="ISO-8859-1" omit-xml-declaration="yes" />
            ...
            <xsl:otherwise>
              <table width="100%" class="tb1" id="tbCabe">
                      <tr class="tbLabel">
                        ...
                        <td class="escritorio" style='text-align: center; width:7%'>
                            <script>campos_head.agregar('Nro. documento', true, 'nro_docu')</script>
                        </td>

                        <td class="escritorio" style='text-align: center; width:20%'>
                            <script>campos_head.agregar('Raz. social', true, 'razon_social')</script>
                        </td>

                        <!-- Nro documento + razon social en un campo -->
                        <td class="mobile" style='text-align: center;'>
                          <script>campos_head.agregar('Raz. social', true, 'razon_social')</script>
                        </td>
                        
                        <td class="ocultar_mobile" style='text-align: center; width:22%'>
                        ...
                        <td class="ocultar_mobile" style='text-align: center; width:7%'>
    ...
    <xsl:template match="z:row">
        ...
        <tr>
            ...
            <td class="escritorio" style='text-align: left; width:7%'>
              <xsl:value-of select="@nro_docu"/>
            </td>
            
            <td class="escritorio" style='text-align: left; width:20%'>
            ...
            <td class="mobile" style='text-align: left;'>
              ...
              <xsl:choose>
                <xsl:when test="string-length(@razon_social) &#62; 22">
                  <xsl:value-of select="substring(@razon_social, 1, 22)"/>...
                </xsl:when>
                <xsl:otherwise>
                  <xsl:value-of select="@razon_social"/>
                </xsl:otherwise>
            ...
            <td class="ocultar_mobile" style='text-align: left; width:22%'>
            ...
            <td class="ocultar_mobile" style='text-align: right; width:7%'>
