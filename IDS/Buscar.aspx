                        ...
                        switch ($tipo_docu.value)
                        {
                            case "8":
                                if ($nro_docu.value.toString().length == 11) {
                                    ...
                                    window.top.alert('El CUIT ingresado debe tener 11 dígitos.');
                                    return
                                }
                                break;
...
<body onload="window_onload()" style='overflow: hidden;'>
    ...
    <table class="tb1" cellspacing="0" cellpadding="0">
        <tr class="tbLabel0">
            <td style="text-align: center; font-weight: bold !important;">Búsqueda Eventos</td>
        </tr>
        ...
        <tr>
            <td>
                <table class="tb1">
                    ...
                    <tr>
                        <td class="Tit1" title="Puede utilizar * como comodín para la búsqueda">ID</td>
                        <td title="Puede utilizar * como comodín para la búsqueda">
                            <script type="text/javascript">
