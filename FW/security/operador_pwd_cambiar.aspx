...
<head>
    <title>Operador - Cambiar Contraseña</title>
        ...
        function btnAceptar_pwd_set_onclick() {
            ...
            nvFW.error_ajax_request('operador_pwd_cambiar.aspx', {
                ...
                onSuccess: function (err, transport) {
                    ...
                    alert("La contraseña fue seteada correctamente.", {
                        title: "",
                        width: 350,
                        onOk: function (w) {
                            w.close()
...
<body onload="return window_onload()" onresize="window_onresize()" style="height: 100%;
    ...
    <div id="divSetear_pwd" style="width: 100%;height:100%">
        <table class="tb1" style="font-size: 13px;">
            ...
            <tr>
                <td style="width: 30%; white-space: nowrap; padding-top: 5px; text-align: right;">Contraseña actual:&nbsp;</td>
                <td>
            ...
            <tr>
                <td style="width: 30%; white-space: nowrap; padding-top: 5px; text-align: right;">Confirmar contraseña nueva:&nbsp;</td>
                <td>
