...
vButtonItems[5]["etiqueta"] = "Dehabilitar Acceso a la Aplicación";
   ...
   function YYYYMMDD(strFecha) 
    ...
    function btnAceptar_pwd_set_onclick(setea)
    {
        ...
        if (pwd_new_conf != pwd_new && !(pwd_new_conf == "" || pwd_new == "")) {
            alert('La contraseña o la confirmación no coinciden. Verifique')
            return
        }
        ...
        <table class="tb1">
         <tr>
                            ...
                            <td style="width:60%">
                               <table class="tb1">
                                   <tr>
                                    ...
                                    <tr>
                                        <td style='width: 50%;text-align: left'><input type="checkbox" name="cuenta_cambiar_pwd" id="cuenta_cambiar_pwd" style='width: 5%; text-align: center; border:0' />El usuario debe cambiar la contraseña en el siguiente inicio de sesión.</td>
                                    </tr>
                               </table>
                           </td>
                       </tr>
            ...
            <div id="divEntidad" style="margin: 0px; padding: 0px;"></div>
               ...
               <table style="width:100%">
                      <tr>
                         <td class="Tit4" style="width: 15%;vertical-align: middle; text-align: center;display:none" nowrap="nowrap"><b>Nº Entidad</b></td>
                    ...
                    <tr>
                     <td style="width:100%">
                       <table style="width:100%" class="tb1">
                           <tr>
                               <td colspan="5"><b>Usted no habilitó la cuenta</b>.&nbsp;Seleccione que desición desea tomar:</td>
                           </tr>
                            <tr>
                               <td colspan="5">&nbsp;</td>
                           </tr>
                           ...
                           <tr>
                               <td colspan="5">- Deshabilitar acceso a la aplicación: el operador no tendra acceso a la aplicación <b><%= nvApp.sistema  %></b>.</td>
                           </tr>
                           <tr>
                               <td colspan="5">&nbsp;</td>
                           </tr>
