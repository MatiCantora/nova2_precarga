...
<head>
    ...
    <script type="text/javascript">
        ...
        //function dibujarResultados(obj_error)
        //{
        //    if (obj_error)
        //    {
        //        var html =  '<tr><td class="Tit1" style="text-align: center;" colspan="2">Resultado de la consulta</td></tr>' +
        //                    //'<tr><td class="Tit4">Mensaje</td><td>' + obj_error.mensaje + '</td></tr>' +
        //                    '<tr><td class="Tit4">Numero Estado</td><td>' + obj_error.params.numero + '</td></tr>' +
        //                    '<tr><td class="Tit4">Descripción Estado</td><td>' + obj_error.params.descripcion + '</td></tr>' +
        //                    '<tr><td class="Tit4">CUIT Ingresado</td><td>' + obj_error.params.cuit + '</td></tr>' +
        //                    '<tr><td class="Tit4">' + (control_seleccionado == 'cuitcbu' ? 'CBU' : 'Alias') + ' Ingresado</td><td>' + (control_seleccionado == 'cuitcbu' ? obj_error.params.cbu : obj_error.params.alias) + '</td></tr>';

        //        $('tbResultados').select('tbody')[0].innerHTML = html;
        //    }
        //}
    </script>
</head>
