...
<%
    ...
    Try
        ...
        For each item in oNsValidate
            ...
            token = LTrim(RTrim(item.SelectSingleNode("@token").Value))
            ...
            strXML = strXML & "<item token='" & token & "'  validacion='" & validacion & "' ></item>"
    ...
    nvDBUtiles.DBExecute("update validaciones set xmlValidate='" & strXML.Replace("'", "") & "' where token='" & token & "'")
