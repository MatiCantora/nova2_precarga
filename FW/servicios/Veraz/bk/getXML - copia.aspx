    ...
    Select Case accion.ToLower
        Case "obtener_preguntas"
            Try
                ...
                Dim id_ambiente As String = "1" 'XML.SelectSingleNode("criterio/id_ambiente").InnerText
        ...
        Case "validar"
            Try
                ...
                If Session.Contents("webservice") Is Nothing Then


                Else
                    Dim eqPreguntasResponse As nvFW.servicios.veraz.eqPreguntasResponse = Session.Contents("webservice")
                    If Equals(Session.Contents("webservice"), eqPreguntasResponse) = True Then
                        ...
                        Try
                            ...
                            If eqPreguntasResponse.numError = 0 Then
                                ...
                                eqPreguntasResponse.saveResultDb(cn)
                                cn.Close()
