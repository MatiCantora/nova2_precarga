...
<% 
    ...
    Me.contents("filtro_resultado_descarga") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verLn_resultados'><campos>Comments,AdditionalInfo,[file],Name,BestName,Published,BestNameScore,AlertState,ResultID,Comments,AdditionalInfo,nro_consulta,tipo_docu,documento,nro_docu,apellido,nombres,sexo,pais,division,PredefinedSearchName,[user],fe_consulta,fe_vigente,vigente,fe_naci</campos><orden></orden><filtro></filtro></select></criterio>")
        ...
        var otraVentana;
         ...
         function confirm_vigencia(nro_consulta) { 
             if (nvFW.tienePermiso('permisos_lexisnexis', 1) ) {
                 var strHTML = "<br/><table class='tb1'><tr><td nowrap>¿Está seguro de eliminarpermisos el estado de vigencia de la consulta nro. " + nro_consulta + "? Los cambios no pueden ser desechos.</td> </tr></table>"
                 nvFW.confirm(strHTML,
                     {
        ...
        <table id="tbFiltros" class="tb1" style="width: 100%">
            <tr>
                ...
                <script type="text/javascript">
                    ...
                    Menus["vMenuModulos"].CargarMenuItemXML("<MenuItem id='0' style='WIDTH: 900%'><Lib TipoLib='offLine'>DocMNG</Lib><icono></icono><Desc>Nueva consulta</Desc></MenuItem>")
