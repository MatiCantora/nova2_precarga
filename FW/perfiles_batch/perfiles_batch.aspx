            ...
            Dim nT As New System.Threading.Thread(Sub(objeto As Object())
                                                      ...
                                                      Try
                                                          ...
                                                          If estadoProceso = 2 Then
                                                              nvFW.nvDBUtiles.DBExecute("update procesos set pr_estado = 1 where nro_proceso = " & nro_proceso1 & "; insert into proceso_log (nro_proceso, momento, observacion ) values (" & nro_proceso1 & ", getdate(), ' Fin ejecución batch.')")
                                                          Else
                                                              nvFW.nvDBUtiles.DBExecute("update procesos set pr_estado = " & estadoProceso & " where nro_proceso = " & nro_proceso1 & "; insert into proceso_log (nro_proceso, momento, observacion ) values (" & nro_proceso1 & ", getdate(), ' Fin ejecución batch.')")
                                                          End If
                                                          
                                                      Catch e As Exception
                                                          nvDBUtiles.DBCloseRecordset(rs1)
                                                          nvFW.nvDBUtiles.DBExecute("update procesos set pr_estado = 4 where nro_proceso = " & nro_proceso1 & "; insert into proceso_log (nro_proceso, momento, observacion ) values (" & nro_proceso1 & ", getdate(), 'Fin. Error ejecución batch. " & e.Message & "')")
                                                      End Try
                                                  End Sub)
