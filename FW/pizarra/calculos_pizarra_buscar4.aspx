...
<% 
    ...
    Dim nro_permiso As Integer = 2
    Dim tiene_permiso_creacion As Boolean = nvFW.nvApp.getInstance().operador.tienePermiso("permisos_pizarra_gral", Math.Pow(2, nro_permiso - 1))
