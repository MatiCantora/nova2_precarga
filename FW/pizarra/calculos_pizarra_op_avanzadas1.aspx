...
<head>
    ...
    <style type="text/css">select:disabled { background-color: #e9e9e4; }</style>
    ...
    <script type="text/javascript">
        ...
        {
            if (ventana.options.userData.valores_salida != undefined) {
        ...
        {
            // tipo_dato
            if (arr_tipo_dato == null) {
                cargar_select_tipo_dato()
            }

            // campos_defs
            if (arr_campos_defs == null) {
        ...
        {
            // Marcar las opciones
            $('pizarra_cubo').checked = ventana.options.userData.pizarra_cubo
        }
        ...
        function cargar_salidas()
        {
            ...
            if (ventana.options.userData["valores"].length > 0)
        ...
        function dibujar_select_tipo_dato(name_id, tipo_dato)
        {
            ...
            var seleccionar_item = tipo_dato != "" && tipo_dato != undefined ? true : false
            var seleccionado     = ''
        ...
        function dibujar_select_campos_defs(name_id, id_campo_def)
        {
            ...
            var seleccionar_item = id_campo_def != "" && id_campo_def != undefined ? true : false
            var seleccionado     = ''
            var str_campo_def    = "<select style='width:100%' name='" + name_id + "' id='" + name_id + "'>"
            str_campo_def       += "<option value=''></option>"

            arr_campos_defs.each(function (campo_def, i) {
        ...
        {
            if (cantidad_valores == SALIDAS_MAX) {
                alert("Sólo se pueden agregar hasta <b>" + SALIDAS_MAX + " salidas adicionales</b>.")
                return false;
            }
        ...
        function obtener_arreglo_valores()
        {
            ...
            if (cantidad_valores > 0) {
                for (var i = 0; i < SALIDAS_MAX; i++) {
                    if ($("id_nro_calc_pizarra_" + i) != null) {
                        arr_valores[i] = {}
        ...
        function get_xml()
        {
            ...
            arr_valores.each(function(valor) {
                xml += '<salida id_nro_calc_pizarra="' + valor["id_nro_calc_pizarra"] + '" nro_calc_pizarra="' + valor["nro_calc_pizarra"] + '" prefijo="' + valor["prefijo"] + '" posfijo="' + valor["posfijo"] + '" tipo_dato="' + valor["tipo_dato"] + '" campo_def="' + valor["campo_def"] + '" etiqueta="' + valor["etiqueta"] + '" ancho="' + valor["ancho"] + '" orden="' + valor["orden"] + '" />'
            })
...
<body onload="window_onload()" onresize="window_onresize()" style="width: 100%; height: 100%; overflow: hidden; background-color: white;">
    ...
    <script type="text/javascript">
        nvFW.bloqueo_activar($$("body")[0], "vidrio_cargar", "Cargando...")
    </script>
    ...
    <form name="form_valores" id="form_valores" autocomplete="off" style="width: 100%; height: 100%; margin: 0;">
        ...
        <table class="tb1 highlightOdd highlightTROver" id="tbCubo">
            ...
            <tr>
                <td style="width: 50px; text-align: center;">
                    <input type="checkbox" name="pizarra_cubo" id="pizarra_cubo" style="cursor: pointer;" title="Si está seleccionado la pizarra se utilizará como CUBO" />
                </td>
                <td>
        ...
        <table class="tb1" id="tbValores">
            ...
            <tr id="tr_salida">
                ...
                <td><input type="text" name="accion" id="accion" value="-" style="width: 100%; text-align: center;" disabled="disabled" /></td>
            </tr>
            <tr>
