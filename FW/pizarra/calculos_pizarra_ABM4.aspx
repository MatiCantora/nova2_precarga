    ...
    <script type="text/javascript">
        ...
        function pizarra_datos_det_cargar(filtros)
        {
            ...
            rs.open({
                ...
                filtroWhere: "<criterio><select><filtro><nro_calc_pizarra type='igual'>" + nro_calc_pizarra + "</nro_calc_pizarra>" + filtros + "</filtro>" + (Pizarra['auto_ordenada'] ? "<orden>orden</orden>" : "") + "</select></criterio>",
            })
            ...
            <table id="tb_pizarra" class="tb1">
                ...
                <tr>
                    ...
                    <td style="width: 6%; text-align: center;">
                        <input type="checkbox" name="auto_ordenada" id="auto_ordenada" title="Auto ordenado" style="cursor: pointer;" />
                    </td>
