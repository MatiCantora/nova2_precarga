...
<%
    ...
    Dim id_transferencia As Integer = nvUtiles.obtenerValorType("id_transferencia", 0, nvConvertUtiles.DataTypes.int)
    ...
    Dim pasada As Integer = nvUtiles.obtenerValorType("pasada", 0, nvConvertUtiles.DataTypes.int)
    ...
    Dim id_transf_log As Integer = nvUtiles.obtenerValorType("id_transf_log", 0, nvConvertUtiles.DataTypes.int)
    ...
    Me.contents("filtroBucleEjecucion") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verTransf_log_det'><campos>id_transf_log_subproc,fe_fin_det,nombre_operador,dbo.transf_USR_permiso_pendiente(id_transf_log,id_transf_det) as permiso_pendiente" _
        ...
        & "comentario, debug_desc, debug_src, link, script,salida_tipo,parametros_extra_xml,resumen as obs</campos><filtro></filtro><orden>fe_fin_det</orden></select></criterio>")
         ...
         if($(Transf.param[i]['parametro']).value != '')
          {
           ...
           if (resultado == null && $(Transf.param[i]['parametro']).value.indexOf(".") > -1)
            {
...
{ 
    ...
    try
        ...
        if (err.numError == 0)
          ...
          //err.alert()
		   alert(err.mensaje, {className: "alphacube", width:400, height:150, okLabel: "cerrar"})
        ...
        If oParametro("editable") Or oParametro("visible") Then
            ...
            If oParametro("campo_def") = "" And calendario = "" Then
                ...
                If oParametro("tipo_dato").ToUpper() = "FILE" Then
                    ...
                    Try
                        If Not Transf.transf_det_pendiente.param(parametro)("valor") Is Nothing And Transf.transf_det_pendiente.param(parametro)("tipo") <> "requerido" Then
                        ...
                        If Not Transf.transf_det_pendiente.param(parametro)("valor") Is Nothing And Transf.transf_det_pendiente.param(parametro)("tipo") = "visible" Then
            ...
            'si es funcion 
            If Not (oParametro("valor") Is Nothing) AndAlso oParametro("tipo_dato").toUpper() <> "VARCHAR" AndAlso oParametro("valor").tostring.indexOf("()") > -1 Then valor_script = oParametro("valor")
            ...
            If Not oParametro("valor") Is Nothing Or valor_script <> "''" Then
                If oParametro("tipo_dato").toUpper() = "BIT" Then
                    setear_valores += "$(""" & parametro & """).checked = " & valor_script.replace("'","") & " " & vbCrLf  'oParametro("valor").ToString.ToLower
                Else
                    If oParametro("campo_def") = "" Then
