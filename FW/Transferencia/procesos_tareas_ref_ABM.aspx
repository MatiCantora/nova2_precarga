be<%@ Page Language="VB" AutoEventWireup="false" Inherits="nvFW.nvPages.nvPageFW" %>
...
<% 
    ...
    Dim ejecucion As String = nvUtiles.obtenerValor("ejecucion", "")
    ...
    If (modo <> "C") Then
        ...
        Try
            ...
            If (nro_transf_pt_ref = 0) Then
                ...
                StrSQL = "INSERT INTO transf_pt_ref(descripcion,id_transferencia,vigente,nro_permiso_grupo,nro_permiso,async"
                For Each i As String In arrParam.Keys
                    StrSQL += ", id_transf_pt_param" & i
                Next
                StrSQL = StrSQL & ") " & vbCrLf & " VALUES ('" & descripcion & "', " & id_transferencia & ", " & vigente & ",NULL,NULL," & ejecucion
            ...
            If (nro_transf_pt_ref > 0) Then
                ...
                StrSQL += " descripcion = '" & descripcion & "', nro_permiso_grupo = NULL, async = " & ejecucion & ", nro_permiso = NULL, id_transferencia = " & id_transferencia & " "
...
function proceso_ref_cargar() {
  ...
  if (!rs.eof())
  {
      ...
      $('modo_ejecucion').value = rs.getdata('async')=='True'?"Asincronico":"Sincronico"
...
<body onload="return window_onload()" onunload ="return window_onunload()" style="width:100%;height:100%;overflow:hidden">
    ...
    <input type="hidden" name="control_vigente" id="control_vigente" value="<%= control_vigente%> " />
                  <table class="tb1">                      
                     <tr class="tbLabel">
                          <td style="width:35%;text-align:center" colspan="2">Descripción</td>
                          <td style="width:30%;text-align:center">Transferencia</td>
                     ...
                     <table class="tb1">     
                        ...
                        <%
                            ...
                            Response.Write("<td>Modo Ejecución</td>")
                            Response.Write("</tr>")
