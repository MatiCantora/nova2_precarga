...
function window_onload() 
{
   ...
   $('nombre').focus()
    ...
    //por default muestra las transferencias del operador
   // btnMostrar_transferencia(true)
...
function btnMostrar_transferencia(primera_vez) 
{
   ...
   // if (primera_vez === true)
    //   filtroWhere = "<criterio><select><filtro><operador type='igual'>"+ nvFW.pageContents.operador +"</operador></filtro><orden>transf_fe_modificado desc</orden></select></criterio>"
...
function seleccion(e,valor,desc) 
{
    if (e.ctrlKey == true || e.shiftKey == true)
        window.open('/fw/transferencia/transferencia_abm.aspx?id_transferencia=' + valor, "_blank")
    else {
