...
(function () {
    CKEDITOR.dialog.add("link", function (e) {
        ...
        return {
                        ...
                        if ("url" == n) {
                            ...
                            if ($('selURLType').input_url.value != '') {
                                ...
                                if (m != null) {
                                    ...
                                    var erRes = nvFW.error_ajax_request("/fw/files/file_properties.aspx", { asynchronous: false, parameters: { modo: "get_properties", ref_files_path: m[1] } })
            ...
            onShow: function () {
                ...
                if (c != null)
                    if ($('selURLType').input_url != null) {
                        $('selURLType').input_url.value = c.$.pathname + c.$.search
                    }
            },
            onOk: function () {
                var a = {};
            ...
            onLoad: function () {
                // Sistema == WIKI => Revisar permiso para subir archivos. [Permiso 1] : subir archivo
                if (window.top.app_cod_sistema == "nv_wiki" && !window.top.tienePermisoReferencia(1)) {
                    e._.storedDialogs.link.definition.dialog.parts.close.$.click()
                    alert("No tiene el permiso necesario para subir archivos. Consulte con el Administrador del Sistema.")
                }
                else {
