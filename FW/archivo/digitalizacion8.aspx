...
<body id="cuerpo" onload="return window_onload()" onresize="window_onresize()" style="width: 100%; /*height: 100%;*/ /*overflow: auto*/">
    ...
    <script type="text/javascript">
        ...
        Menus["vMenuDig"].CargarMenuItemXML("<MenuItem id='2'><Lib TipoLib='offLine'>DocMNG</Lib><icono>buscar1</icono><Desc>Marcar como no digital</Desc><Acciones><Ejecutar Tipo='script'><Codigo>fisicoMasivo('RPT')</Codigo></Ejecutar></Acciones></MenuItem>")
...
<%--                        <td class="Tit1" style="width: 4%;text-align:center;"><b>Sin asignar</b></td>--%>
                        <td class="Tit1" style="width: 10%;text-align:center;"><b>Condición</b></td>
...
<%--                        <td style="width: 6%; text-align:center;" >
                        ...
                        <td style="width:10%">
                            <select style="width:100%" id="filRel" onchange="habilitarFiltros()">
                               <option value=""></option>
                               <option value="0">Vencidos / Sin Asignar</option>
