...
<head>
    ...
    <script type="text/javascript">
        ...
        function window_onload() {
            ...
            var strHTML = '<table class="tb1  highlightOdd highlightTROver layout_fixed highlightOdd highlightTROver layout_fixed" style="width:100%"><tr class="tbLabel0"><td>Documento</td><td style="width:300px">Archivo</td><td style="width:300px">Fecha</td><td style="width:300px">Operador</td><td style="width:300px">Estado</td></tr>'
            while (!rs.eof()) {
                strHTML += '<tr><td width="40%"><a target="_blank" href="/fw/archivo/get_file.aspx?nro_archivo=' + rs.getdata('nro_archivo') + '">' + rs.getdata('Descripcion') + ' - ' + rs.getdata('nro_archivo') + '</a></td>'
