...
<%
    ...
    If accion.Tolower = "guardar" Then
        ...
        If (parametro_valor <> "") Then
            ...
            Try
                ...
                If parametro.toLower = "ar_fe_documento" Then
    ...
    Me.contents("filtro_estado") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_estado'><campos>*</campos><filtro></filtro><orden></orden></select></criterio>")
