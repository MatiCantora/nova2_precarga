...
<%
    Me.contents("verArchivos_parametros") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verArchivos_parametros'><campos>campo_def,parametro_valor,etiqueta</campos><orden></orden><grupo></grupo><filtro></filtro></select></criterio>")
    ...
    Dim nro_archivo_id_tipo = obtenerValor("nro_archivo_id_tipo", "")
...
<head>
    ...
    <script type="text/javascript">
        ...
        function cargar_archivos() {
            ...
            rs.open(nvFW.pageContents.filtro_verArchivos, "", filtro_nro_archivo + "<id_tipo type='igual'>" + id_tipo + "</id_tipo><nro_archivo_estado type='igual'>1</nro_archivo_estado>")
            var i = 0
            while (!rs.eof()) {
