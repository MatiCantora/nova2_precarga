...
<%
    ...
    Dim parametro_valor = obtenerValor("parametro_valor", "")
    Dim parametro = obtenerValor("parametro", "")
    Dim nro_archivo_params = obtenerValor("nro_archivo_params", "")
...
///////////////////////////////////////////////////////////
        ...
        function window_onload() {
            ...
            //////HISTORIAL//////
            id_tipo = Parametros["nro_registro"]
            nro_archivo_id_tipo = Parametros["id_tipo"]
            nro_def_detalle = Parametros["nro_archivo_id_tipo"]
            ...
            nvFW.exportarReporte({
                ...
                path_xsl: "report\\historial_archivos\\HTML_historial_archivos.xsl",
                formTarget: 'tbDocs',
        ...
        function btnAceptar_onclick_1() {   
            ...
            } else alert('No cambio el estado')
