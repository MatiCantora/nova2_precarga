...
<%
    ...
    Dim nro_def_archivo As String = nvFW.nvUtiles.obtenerValor("nro_def_archivo", "1")
    Dim cuit As String = nvFW.nvUtiles.obtenerValor("cuit", "20259040354")
    Dim razonsocial As String = nvFW.nvUtiles.obtenerValor("razonsocial", "Juan Olivera")
    Dim sexo As String = nvFW.nvUtiles.obtenerValor("sexo", "M")
    ...
    Me.contents("verArchivos") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verArchivos_idtipo'><campos>*</campos><filtro>" + filtro_idtipo + filtro_nro_def_archivo + "</filtro><orden>orden</orden></select></criterio>")
    Me.contents("cda") = nvUtiles.getParametroValor("nosis_cda_default")
    Me.contents("razonsocial") = razonsocial
    Me.contents("sexo") = sexo
    Me.contents("cuit") = cuit
    Me.contents("nro_docu") = cuit.Substring(2, cuit.Length - 3)
       ...
       //var orden = win.options.userData.nro_com_id_tipo;
        ...
        function cargarHistorial() {
            nvFW.exportarReporte({
                ...
                parametros: "<parametros><nro_docu>"+  nvFW.pageContents.nro_docu  +"</nro_docu><cuit>"+  nvFW.pageContents.cuit  +"</cuit><sexo>"+  nvFW.pageContents.sexo  +"</sexo><razonsocial>"+ nvFW.pageContents.razonsocial +"</razonsocial><cda>"+ nvFW.pageContents.cda +"</cda><id_tipo><% = id_tipo %></id_tipo><nro_archivo_id_tipo><% = nro_archivo_id_tipo %></nro_archivo_id_tipo><nro_def_archivo_actual><% = nro_def_archivo %></nro_def_archivo_actual></parametros>",
