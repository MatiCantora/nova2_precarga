                ...
                For Each campo In Request.Files.AllKeys
                    ...
                    If Request.Files(campo).FileName <> "" Then
                        ...
                        archivo = New tnvArchivo(BinaryData:=binaryData, id_tipo:=id_tipo, nro_archivo_id_tipo:=nro_archivo_id_tipo _
                                                    , nro_def_archivo:=nro_def_archivo, nro_def_detalle:=nro_def_detalle, descripcion:=descripcion, extension:=ext _
                                                    , orden:=orden _
                                                    , nro_img_origen:=nro_img_origen, xmlInfo:=xmlInfo, xmlError:=xmlError, version:=version, ComputerName:=ComputerName)
