...
///////////////////////////////////////////////////////////
        ...
        function cargarParametros() {
            ...
            var rs1 = new tRS();
            rs1.open(strCriterioParams, "", "<NOT><etiqueta type='isnull'/></NOT><nro_archivo_estado type='in'>1,3</nro_archivo_estado><nro_def_detalle type='igual'>" + nro_def_detalle + "</nro_def_detalle><nro_archivo_id_tipo type='igual'>" + nro_archivo_id_tipo + "</nro_archivo_id_tipo><id_tipo type='igual'>" + id_tipo + "</id_tipo>", "", "")
        ...
        function def_archivo (nro_def_archivo, accion) { 
                ...
                win_archivos_def_abm = w.createWindow({
                    className: 'alphacube',
                    url: '/fw/def_archivos/archivos_def_ABM.aspx?nro_def_archivo=' + tipo + '&accion="C"',
