                    ...
                    If Not nvApp.sica_control.thread.IsAlive Then
                        For i = 0 To nvApp.sica_control.elements.Count - 1
                            ...
                            strXML += "<resElement path='" & nvApp.sica_control.elements(i).path & "' objeto='" & nvApp.sica_control.elements(i).objeto &
                                ...
                                "'  cod_objeto='" & nvApp.sica_control.elements(i).cod_objeto & "' cod_obj_tipo='" & nvApp.sica_control.elements(i).cod_obj_tipo & "' cod_sub_tipo='" & nvApp.sica_control.elements(i).cod_sub_tipo & "'  cod_modulo_version='" & nvApp.sica_control.elements(i).cod_modulo_version & "' />"
                        Next
                    End If
    ...
    <script type="text/javascript">
        ...
        function ejecutarAccionIntegridad(modo) {
            ...
            for (var i = 0; i < items.length; i++) {
                ...
                strItems += "<objeto cod_modulo_version='" + item.cod_modulo_version + "' " + strCod_objeto + " objeto='" + stringToXMLAttributeString(item.objeto) + "' path='" + stringToXMLAttributeString(item.path) + "' cod_obj_tipo='" + cod_obj_tipo + "' resStatus='" + item.resStatus + "'/>"
            }
            strItems += "</objetos>"
        ...
        function verObjetoIntegridad(cod_objeto, objeto, path_ori, cod_obj_tipo, extension, status) {
            ...
            if (status == '2') {
                ...
                "<source2 modo='GET_IMP' cod_servidor='" + stringToXMLAttributeString(cod_servidor) + "' cod_sistema='" +
                stringToXMLAttributeString(cod_sistema) + "' port='" + port + "' objeto='" + stringToXMLAttributeString(objeto) +
                ...
                mostrarObjetoImplementacion(cod_servidor, cod_sistema, port, objeto, path_ori, cod_obj_tipo, extension)
