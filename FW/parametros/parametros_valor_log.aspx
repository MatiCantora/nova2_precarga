...
<%
    ...
    Dim valor As String = nvUtiles.obtenerValor("valor", "")

    If modo = "desencriptar" Then
        Dim err As New tError()

        err.params("valor") = nvFW.nvSecurity.nvCrypto.EncBase64ToStr(valor)
...
<head>
    ...
    <script type="text/javascript">
        ...
        function desencriptar(valor) {
            nvFW.error_ajax_request("parametros_valor_log.aspx", {
                parameters: {
                    modo: "desencriptar",
                    valor: valor
                },
                onSuccess: function (err) {
                    alert(err.params.valor)
                }
            });
        }
