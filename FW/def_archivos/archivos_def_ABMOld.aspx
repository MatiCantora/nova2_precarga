...
<%
    ...
    Dim filtroArchivoCab = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_cab'><campos>nro_def_archivo,def_archivo,def_fe_baja</campos><filtro><nro_def_archivo type='igual'>%nro_def_archivo%</nro_def_archivo></filtro></select></criterio>")
    Dim filtroGrupoDet = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_grupo_det'><campos>nro_archivo_def_grupo</campos><filtro><nro_def_detalle type='igual'>%nro_def_detalle%</nro_def_detalle></filtro><orden>nro_archivo_def_grupo</orden></select></criterio>")
    Dim filtroArchivoDef = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='verArchivos_def_detalle'><campos>nro_def_detalle,nro_def_archivo,orden,archivo_descripcion,readonly,file_filtro,file_max_size,perfil,archivo_def_perfil,requerido,reutilizable,repetido,print_auto,nro_archivo_def_tipo,archivo_def_tipo,request_usr,ppi,nro_depthcolor</campos><filtro><nro_def_archivo type='igual'>%nro_def_archivo%</nro_def_archivo></filtro><orden>%campo_orden%" + " " + "%sentido_orden%</orden></select></criterio>")
    Dim filtroArchivo = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos'><campos>COUNT(*) as cant_archivos</campos><filtro><nro_def_detalle type='igual'>%nro_def_detalle%</nro_def_detalle><nro_archivo_estado type='igual'>1</nro_archivo_estado></filtro></select></criterio>")
...
<head>
    ...
    var filtroArchivoCab = '<% =filtroArchivoCab %>'
    var filtroGrupoDet = '<% =filtroGrupoDet %>'
    var filtroArchivoDef = '<% =filtroArchivoDef %>'
    var filtroArchivo = '<% =filtroArchivo %>'
    ...
    function dibujar_cargar_archivos_def_detalle() 
    {
        if (archivos.length >= 0) {
            ...
            var strHTML = '<table id="tb_archivos_def_detalle" class="tb1" style="width:100%; vertical-align: top;">'
            ...
            strHTML += '<td style="width:8%;text-align:center">Readonly</td>'
    ...
    function archivos_def_detalle_abm(indice) {
        ...
        win_archivos_def_detalle_abm = w.createWindow({
            ...
            width: 800,
            height: 450,
            onClose: dibujar_cargar_archivos_def_detalle
        });
...
<form name="frmArchivosDefABM" action="/fw/def_archivos/archivos_def_ABM.aspx" method="post" style='width:100%;height:100%;overflow:hidden'>
    ...
    <input type="hidden" name="accion" id="accion" value="<%= accion %>" />
        ...
        <table class="tb1" width="100%" id="tb_archivos_def">
            <tr class="tbLabel">
