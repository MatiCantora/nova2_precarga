...
<%
    ...
    Dim filtroColores = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_IMG_depthcolor' PageSize='14' AbsolutePage='1' cacheControl='Session'><campos>*</campos><orden>nro_depthcolor</orden><filtro></filtro></select></criterio>")
    Dim filtroPerfil = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_perfil'><campos>COUNT(*) as cant_perfiles</campos><filtro><tipo_color type='igual'>%nro_depthcolor%</tipo_color></filtro></select></criterio>")
%>
...
<table width="100%" id="tb_colores">
     <tr>
       <td style="width:80%">
          <table class="tb1" width="100%">
            <tr class="tbLabel">
                <td style='width:100%'><b>Colores</b></td>
            </tr>
            <tr>                
                <td><%= nvFW.nvCampo_def.get_html_input("nro_depthcolor") %></td>
            </tr>
          </table>
       </td>
...
<iframe name="iframe_colores" id="iframe_colores" style='width: 100%; height: 100%; overflow: auto; border:none' frameborder="0" src="/fw/enBlanco.htm"></iframe>
</form>
</body>
</html>