...
<%
    ...
    Dim nroArDef As String = nvFW.nvUtiles.obtenerValor("nroArDef", "")
    Dim modo As String = nvFW.nvUtiles.obtenerValor("modo", "")
    If modo = "" Then
        modo = "VA"
    End If

    Me.contents("nroArDef") = nvFW.nvUtiles.obtenerValor("nroArDef", "")
...
<head>
    ...
    var nroArDef = nvFW.pageContents.nroArDef
    ...
    var paramsGlob = []
    paramsGlob = sessionStorage.setItem("paramsGlob", JSON.stringify(paramsGlob))
    ...
    function dibujar_cargar_archivos_def_detalle() 
    {
        ...
        if (nvFW.pageContents.nroArDef != '' && flag == 0) {
            var cont = 0
            var ind = 9
           
            while (ind < $$('#div_archivos_def_detalle td').length) {

                if ($$('#div_archivos_def_detalle td')[ind].innerText == nvFW.pageContents.nroArDef) {
                    archivos_def_detalle_abm(cont)
                    return
                }
                cont = cont + 1
                ind = ind + 9
