...
<%
    ...
    Me.contents("filtroTipo") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_tipo'><campos>nro_archivo_def_tipo,archivo_def_tipo</campos><filtro><nro_archivo_def_tipo type='igual'>%nro_archivo_def_tipo%</nro_archivo_def_tipo></filtro></select></criterio>")
    Me.contents("filtroExiste") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_tipo'><campos>*</campos><filtro><archivo_def_tipo type='igual'>%archivo_def_tipo%</archivo_def_tipo></filtro></select></criterio>")
...
<form name="frmArchivosDefTipoABM" action="/fw/def_archivos/archivos_def_tipo_ABM.aspx" method="post" style='width:100%;height:100%;overflow:hidden'>
    <input type="hidden" name="modo" id="modo" value="<%= modo %>" />
        ...
        <table class="tb1" id="tb_archivos_def_tipo">
            <tr class="tbLabel">
