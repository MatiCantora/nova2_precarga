...
<%
    Dim filtroBusquedaCab = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_cab' PageSize='19' AbsolutePage='1' cacheControl='Session'><campos>*</campos><orden>nro_def_archivo</orden><filtro></filtro></select></criterio>")
    Dim filtroDetalle = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos_def_detalle'><campos>nro_def_detalle</campos><filtro><nro_def_archivo type='igual'>%nro_def_archivo%</nro_def_archivo></filtro></select></criterio>")
    Dim filtroArchivos = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='archivos'><campos>COUNT(*) as cant_archivos</campos><filtro><nro_def_detalle type='igual'>%nro_def_detalle%</nro_def_detalle></filtro></select></criterio>")
...
<head>
    ...
    <script type="text/javascript">
        ...
        var filtroBusquedaCab = '<%= filtroBusquedaCab %>'
        var filtroDetalle = '<%= filtroDetalle %>'
        var filtroArchivos = '<%= filtroArchivos %>'        
...
<script language="javascript" type="text/javascript">
    ...
    Menus["vMenuArchivosDefSeleccion"].CargarMenuItemXML("<MenuItem id='4'><Lib TipoLib='offLine'>DocMNG</Lib><icono>nuevo</icono><Desc>Nueva Def. de Archivos</Desc><Acciones><Ejecutar Tipo='script'><Codigo>archivos_def_abm(0,'N')</Codigo></Ejecutar></Acciones></MenuItem>")
    vMenuArchivosDefSeleccion.MostrarMenu()
</script>
<table class="tb1" width="100%" id="tb_definicion_archivos">
     <tr>
       <td style="width:70%">
          <table class="tb1" width="100%">
            <tr class="tbLabel">
                <td style='width:100%'><b>Definición de Archivos</b></td>
            </tr>
            <tr>                
                <td><%= nvFW.nvCampo_def.get_html_input("nro_def_archivos3")%></td>
            </tr>
          </table>
       </td>
...
<iframe name="iframe_definicion_archivos" id="iframe_definicion_archivos" style='width: 100%; height: 100%; overflow: auto; border:none' frameborder="0" src="/FW/enBlanco.htm"></iframe>
</form>
</body>
</html>