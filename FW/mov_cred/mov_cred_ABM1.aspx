        ...
        Try
            ...
            Else
                ...
                For i As Integer = 0 To nodosArchivos.Count - 1
                    ...
                    Dim monto_mov As Integer = nodosArchivos(i).Attributes("monto_mov").Value
                    Dim tasa_mov As Integer = nodosArchivos(i).Attributes("tasa_mov").Value
                    ...
                    Dim fe_mov As String = nodosArchivos(i).Attributes("fe_mov").Value
                    ...
                    Dim fe_estado_mov As String = nodosArchivos(i).Attributes("fe_estado_mov").Value
...
<head>
    ...
    <script type="text/javascript">
        ...
        function editar_movimiento(id_mov) {
            ...
            var date1 = rs1.getdata('fe_mov').substr(8, 2) + "/" + rs1.getdata('fe_mov').substr(5, 2) + "/" + rs1.getdata('fe_mov').substr(0, 4)
            var date2 = rs1.getdata('fe_estado_mov').substr(8, 2) + "/" + rs1.getdata('fe_estado_mov').substr(5, 2) + "/" + rs1.getdata('fe_estado_mov').substr(0, 4)
            ...
            $('mov_recursos_tipos').value = rs1.getdata('nro_mov_recurso_tipo')
            $('mov_estados').value = rs1.getdata('estado_mov')
            $('mov_tipos').value = rs1.getdata('nro_mov_tipo')
            ...
            $('inOrigen').value = rs2.getdata('razon_social') + '(' + nrodocOr + ')'
            ...
            $('inDest').value = rs3.getdata('razon_social') + '(' + nrodocDes + ')'
...
<table id="tablaCont" style="width:100%" class="tb1">
    <tr>
        <td style="width:65%">
            <table style="width:100%" class="tb1">
                <tr class="tbLabel">
                    <td style="text-align:center" >Tipo venta</td>
        ...
        <td style="width:35%">
            <table style="width:100%" class="tb1">
                <tr class="tbLabel">
                    ...
                    <td style="width:50%;text-align:center">Monto venta</td>
                </tr>
                <tr>
                    <td style="width:100%;display:flex">
<%--                        <input id="tasa" style="width: 100%" type="text" value=0 />--%>
                        <script type="text/javascript">
                            campos_defs.add('tasa', { enDB: false, nro_campo_tipo: 100 })
                            $('tasa').value = 0
                            $('tasa').setStyle({ width: '97%' })
                        </script>%
                    </td>
                    <td >
<%--                        <input id="monto" style="width: 100%" type="text" value=0 />--%>
                        <script type="text/javascript">
                            campos_defs.add('monto', { enDB: false, nro_campo_tipo: 100 })
                            $('monto').value = 0
