...
<head>
    ...
    <script type="text/javascript">
        ...
        var winSeleccionEnt = nvFW.getMyWindow();
        ...
        {
            let $divEntidades = $('divEntidades')
            let strHTML = ""

            $divEntidades.innerHTML = ''
            strHTML += "<table id='tbEntidades' class='tb1'>"
            strHTML += "<tr>"
            ...
            entidades.each(function(entidad, i) {
                agregar = '<img alt="" title="Agregar" src="/fw/image/icons/agregar.png" style="cursor: pointer;" value="' + entidad['nro_entidad'] + '" onclick="agregar_entidad(\'' + entidad['nro_entidad'] + '\')" />'
                strHTML += "<tr>"
                strHTML += "<td style='width: 5%; text-align: center;'>" + agregar + "</td>"
                strHTML += "<td style='width: 15%; text-align: center;'>" + entidad['nro_entidad'] + "</td>"
                strHTML += "<td style='width: 80%; text-align: left;'>" + entidad['Razon_social'] + "</td>"
                strHTML += "</tr>"
            });
        ...
        function agregar_entidad(nro_entidad)
        {
            ...
            if (nro_entidad != '') {
                ...
                parent.nro_entidad = nro_entidad;
                winSeleccionEnt.close();
        ...
        <table class="tb1">
            ...
            <tr>
                <td style="width: 100%; text-align: center">
                    <div id="divEntidades" style="width: 100%; height: 90%; overflow: auto"></div>
                </td>
            </tr>
        </table>
    </form>
