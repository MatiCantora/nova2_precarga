    ...
    <script type="text/javascript">
        ...
        function entidades_dibujar() {
            ...
            entidades.each(function(arreglo, i) {
                ...
                agregar = '<img alt="" title="Agregar" src="../../fw/image/icons/agregar.png" style="cursor:pointer;cursor:hand" value="' + arreglo['nro_entidad'] + '" onclick="agregar_entidad(\'' + arreglo['nro_entidad'] + '\')" />'
                strHTML += "<tr>"
