...
function detalle_dibujar(id_transf_log, id_transferencia,transferencia,e,id_param1,id_param2,id_param3) 
{
    ...
    if (e.ctrlKey == true) 
       {
          if (e.ctrlKey == true) //con la tecla "Ctrl", abre una nueva pestaña
              window.open('/fw/transferencia/transf_ejecutar.aspx?id_transferencia=' + id_transferencia + '&xml_param='+ strXML_parm +'&id_transf_log=' + id_transf_log + '&ej_mostrar=true&app_path_rel=<%=  nvApp.path_rel  %>')
       }
      else
       {
           ...
           win_transf.setURL('/fw/transferencia/transf_ejecutar.aspx?id_transferencia=' + id_transferencia + '&xml_param='+ strXML_parm +'&id_transf_log=' + id_transf_log + '&ej_mostrar=true&app_path_rel=<%= nvApp.path_rel  %>') // nvUtiles.obtenerValor("app_path_rel", "") %>')
...
<body onload="return window_onload()" onresize="window_onresize()" style="border:0px; width:100%; height:100%; overflow:hidden">
