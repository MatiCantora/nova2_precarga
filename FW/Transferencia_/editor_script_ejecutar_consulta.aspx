...
<%
    ...
    Dim filtroXML As String = nvUtiles.obtenerValor("filtroXML", "")
    Dim objXML As New System.Xml.XmlDocument
    objXML.LoadXml(filtroXML)
    Dim err As New tError()

    Try

        Dim filtro As System.Xml.XmlNode = objXML.SelectSingleNode("/criterio/select/filtro")
        Dim parametros As System.Xml.XmlNode = objXML.SelectSingleNode("/criterio/procedure/parametros")

        Dim consulta As System.Xml.XmlNode = objXML.SelectSingleNode("/criterio/select[not(filtro)]")
        Dim procedure As System.Xml.XmlNode = objXML.SelectSingleNode("/criterio/select[not(filtro)]")
...
<html>
<head>
<title>Transferencia Seleccionar Parámetros</title>
