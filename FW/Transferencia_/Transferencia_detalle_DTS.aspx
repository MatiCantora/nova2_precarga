...
function validar() {
    ...
    if ($('dtsx_path_text').value == '' && $('seluri').value == 'local' && $('cb_parametro_sele').length < 0)
        strError = 'No ha ingresado ningún valor para los campos "Path DTSX" ni "Parametros"'
...
<input type="hidden" name="indice" id="indice" value="<%=indice%>" />
    ...
    <table class='tb1'>
     ...
     <table class='tb1'>
        <tr class='tbLabel'><td colspan="3">Parámetros</td></tr>
        <tr>
           <td style="width:40%; text-align:center">Todos Los Parámetros<select style="width:100%" size="14" name='cb_parametro_total' id='cb_parametro_total' ondblclick ="btn_agregar_onclick()"></select></td>
           ...
           <td style="width:40%; text-align:center">Parámetros Seleccionados<select style="width:100%" size="14" name='cb_parametro_sele' id='cb_parametro_sele' ondblclick ="btn_quitar_onclick()" ></select></td>
        </tr>   
     </table>  
    </div>
