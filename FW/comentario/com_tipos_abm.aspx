...
<head>
    ...
    <script type="text/javascript">
        ...
        function window_onresize() {
            ...
            let alta_main = $('divCabecera').getHeight();
        ...
        function eliminarTipo(nro_com_tipo) {
            if (nro_com_tipo == '') {
                top.nvFW.alert("Tiene que haber un tipo existente marcado para la acción.");
                return;
            }

            modo = 'eliminar';
            let xml = '<?xml version="1.0" encoding="ISO-8859-1"?><tipos><tipo accion="' + modo + '" nro_com_tipo="' + nro_com_tipo + '" ></tipo></tipos>';
    ...
    <div id ="divCabecera">
        ...
        <script type="text/javascript">
            ...
            Menus["vTipos"].CargarMenuItemXML("<MenuItem id='2' style='WIDTH: 5%; text-align:center; vertical-align:middle'>" +
                "<Lib TipoLib='offLine'>DocMNG</Lib><icono>nueva</icono><Desc>Nuevo tipo</Desc><Acciones><Ejecutar Tipo='script'>" +
