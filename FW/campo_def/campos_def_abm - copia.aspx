...
<% 
    ...
    ' Obtener el nombre correcto de tabla para "tipos de campos def" segun la aplicación llamante - sólo cambia con Admin
    Dim strVistaCampoDef As String = IIf(nvApp.cod_sistema = "nv_admin", "campos_def_tipo", "campo_def_tipo")
%>
...
<body  style="overflow:hidden" onload="window_onload()">
    ...
    <table class="tb1">
        ...
        <tr>
            ...
            <td>
                <% = nvFW.nvCampo_def.get_html_input("nro_campo_tipo", enDB:=False, nro_campo_tipo:=1, filtroXML:="<criterio><select vista='" & strVistaCampoDef & "'><campos> distinct nro_campo_tipo as id, campo_tipo as [campo] </campos><orden>[id]</orden><filtro></filtro></select></criterio>") %>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <input name="transporte" type="radio" value="json" /> JSON
                <input name="transporte" type="radio" value="XML" /> XML
            </td>
