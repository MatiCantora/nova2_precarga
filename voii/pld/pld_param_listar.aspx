...
<%
    ...
    If Not op.tienePermiso("permisos_pld", 3) Then
    ...
    If modo.ToUpper() = "M" Then
        ...
        Dim cmd As New nvFW.nvDBUtiles.tnvDBCommand("pld_param_def_abm", ADODB.CommandTypeEnum.adCmdStoredProc)
        ...
        Catch ex As Exception
            ...
            pErr.debug_src = "pld_param_def_abm"
    ...
    Me.contents("filtro_pld_parametros_def") = nvXMLSQL.encXMLSQL("<criterio><select vista='ent_pld_param_def'><campos>*</campos><orden>orden</orden><filtro></filtro></select></criterio>")
%>
    ...
    <script type="text/javascript">
        ...
        function window_onresize() {
            try {
                ...
                var tbParametros_h = $('pldParams').getHeight()
        ...
        function mostrarParams() {
            ...
            paramsRs.open(nvFW.pageContents.filtro_pld_parametros_def);
            var paramsTbody = $("pldParams")
        ...
        function param_def_abm() {
            ...
            var strCriterio = nvFW.pageContents.filtro_pld_parametros_def
            var rs = new tRS();
            rs.open(strCriterio)
            while (!rs.eof()) {
                parametro = {}
            ...
            var options = {
                title: '<b>Parámetros Def PLAyFT</b>',
                maximizable: true,
                minimizable: false,
        ...
        function onSave() {
            ...
            nvFW.error_ajax_request('pld_param_listar.aspx', {
