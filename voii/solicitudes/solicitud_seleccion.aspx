    ...
    <script type="text/javascript">    
        ...
        function cambiar_estado() {
            ...
            if (!check_sol_comparar()) {
                nvFW.alert("Selección de solicitud con estado diferente");
                solicitudes = [];
                estado = '';
                tipo_solicitud = '';
                nro_circuito = '';
                ...
                if (!comparar_tipo) {
                    nvFW.alert("Selección de solicitud con tipo diferente");
                    solicitudes = [];
                    estado = '';
                    tipo_solicitud = '';
                    nro_circuito = '';
                ...
                <td style="width: 90%">
                    <table class="tb1">
                        <tr class="tbLabel">
                            ...
                            <td id="tdDesc" style="text-align: center;">Descripción</td>
                ...
                <td style="width: 90%">
                    <table class="tb1" style="width: 100%">
                        <tr class="tbLabel">
                            ...
                            <td id="tdDesc" style="text-align: center; width: 17%">Descripción</td>
