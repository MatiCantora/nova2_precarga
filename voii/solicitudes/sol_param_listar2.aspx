    ...
    <script type="text/javascript">
        ...
        function onSave() {
            ...
            params.each(function (arr, i) {
                strXML += "<param nro_sol_tipo = '" + campos_defs.get_value('nro_sol_tipo') + "' param = '" + arr.parametro + "' visible = '" + arr.visible + "' orden= '" + arr.orden + "' tipo_dato= '" + arr.tipo_dato + "' requerido= '" + arr.requerido + "' editable = '" + arr.editable + "' campo_def = '" + arr.campo_def + "'>"
