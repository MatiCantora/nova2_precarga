...
<head>
    <title>Solicitud Nº <%= nro_sol %></title>
    ...
    <script type="text/javascript">
        ...
        if (ventana) {
            ...
            ventana.options.closeCallback = function () {
                ...
                //Si está bloqueada por el operador actual, la desbloqueamos al cerrar
        ...
        function window_onload() {
            ...
            rs.onComplete = function (rs) {
                ...
                solicitud = {
                    ...
                    condicion_laboral: new tParam_def({ parametro: "condicion_laboral", valor: rs.getdata("condicion_laboral"), etiqueta: "Condición Laboral", tipo_dato: "varchar", campo_def: "", requerido: true, editable: true }),
                    ...
                    pep: new tParam_def({ parametro: "pep", valor: rs.getdata("pep"), etiqueta: "Expuesto Políticamente", tipo_dato: "varchar", campo_def: "", requerido: true }),
                    ...
                    tel_tipo: new tParam_def({ parametro: "tel_tipo", valor: rs.getdata("tel_tipo"), etiqueta: "Tipo de Teléfono", tipo_dato: "varchar", campo_def: "", requerido: true, editable: true }),
                    ...
                    tel_numero: new tParam_def({ parametro: "tel_numero", valor: rs.getdata("tel_numero"), etiqueta: "Número", tipo_dato: "varchar", campo_def: "", requerido: true, editable: true }),
                    dom_pais: new tParam_def({ parametro: "dom_pais", valor: rs.getdata("dom_pais"), etiqueta: "País", tipo_dato: "varchar", campo_def: "", requerido: true, editable: true }),
                    ...
                    com_cod_postal: new tParam_def({ parametro: "com_cod_postal", valor: rs.getdata("com_cod_postal"), etiqueta: "Código Postal", tipo_dato: "int", campo_def: "", requerido: true, editable: true }),
                    ...
                    dom_nro: new tParam_def({ parametro: "dom_nro", valor: rs.getdata("dom_nro"), etiqueta: "Número", tipo_dato: "int", campo_def: "", requerido: true, editable: true }),
                    ...
                    dom_resto: new tParam_def({ parametro: "dom_resto", valor: rs.getdata("dom_resto"), etiqueta: "Aclaración", tipo_dato: "varchar", campo_def: "", requerido: false, editable: true }),
                    nro_sol: new tParam_def({ parametro: "nro_sol", valor: rs.getdata("nro_sol"), etiqueta: "Número Solicitud", tipo_dato: "int", campo_def: "", requerido: true }),
                    nro_sol_tipo: new tParam_def({ parametro: "nro_sol_tipo", valor: rs.getdata("nro_sol_tipo"), etiqueta: "Número Solicitud Tipo", tipo_dato: "varchar", campo_def: "", requerido: true }),
                    ...
                    sol_desc: new tParam_def({ parametro: "sol_desc", valor: rs.getdata("sol_desc"), etiqueta: "Descripción", tipo_dato: "varchar", campo_def: "", requerido: true }),
                    ...
                    sol_estado_desc: new tParam_def({ parametro: "sol_estado_desc", valor: rs.getdata("sol_estado_desc"), etiqueta: "Estado Descripción", tipo_dato: "varchar", campo_def: "", requerido: true }),
                    ...
                    nro_circuito: new tParam_def({ parametro: "nro_circuito", valor: rs.getdata("nro_circuito"), etiqueta: "Número Circuito", tipo_dato: "int", campo_def: "", requerido: true })
                };
        ...
        function mostrarDatos() {
            ...
            if (solicitud.dom_resto.valor)
                direccion += " - Aclaración: " + solicitud.dom_resto.valor
            ...
            $("plazo").update(solicitud.plazo.valor + " días")
        }
        ...
        function CambiarEstado(abreviacion, fecha) {
           ...
           //                             //Si pasa a estado Terminado, cambia la definición de archivo
           //                             if (solicitud.sol_estado.valor == "T") {
											//$('frame_archivo').contentWindow.cargarHistorial()
           //                             }
           //                             //Si se está visualizando el grupo ABM, debemos actualizar comentarios
        ...
        function td_onclick(e) {
            ...
            switch (id) {
                ...
                case 'telCliente':
                    ...
                    options.title = "<b>Editar Teléfono</b>",
                    options.width = 400
                    break
                case 'com_cod_postal':
                case 'dom_localidad':
        ...
        function imprimirSolicitud() {
            ...
            //    alert("El número de operación no está definido.")
            //    return;
            //}
...
<body id="bsolicitud" onload="window_onload()" onresize="window_onresize()" style="width: 100%; height: 100%; overflow: hidden;">
    <script type="text/javascript">nvFW.bloqueo_activar($$('body')[0], 'bloq_datos', 'Cargando información de solicitud...')</script>
    ...
    <div id="result_vacio" style="width: 100%; text-align: center; font: 13px Tahoma, Arial, sans-serif; height: 100px; position: absolute; top: 50%; left: 50%; margin-top: -50px; margin-left: -50%;display: none">
        ...
        <p style="color: #AAA;">No se encontró la solicitud</p>
    </div>
            ...
            <div class="adaptive">
                ...
                <table class="tb1">
                    <tr class="tbLabel">
                        ...
                        <td style="width:155px">Expuesto Políticamente</td>
        ...
        <div id="solCol" class="adaptive" >
            <div id="solDatos">
                ...
                <table class="tb1" style="width: 100%;">
                    <tr>
                        <td class="Tit2" style="width: 90px">Número:</td>
                    ...
                    <tr>
                        <td class="Tit2" style="width: 90px">Descripción:</td>
                ...
                <script type="text/javascript">
                    ...
                    Menus["vMenuParametro"].CargarMenuItemXML("<MenuItem id='0' style='WIDTH: 100%'><Lib TipoLib='offLine'>DocMNG</Lib><icono></icono><Desc>Parámetros</Desc></MenuItem>")
