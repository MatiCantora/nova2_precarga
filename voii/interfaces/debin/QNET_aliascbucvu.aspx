...
<%
    ...
    Dim e As New tError()
    e.titulo = "Consultar Alias - CBU"
    Dim json_response As New trsParam
    json_response("json_response") = New nvJSON_String("{}")
    ...
    Try
        ...
        Dim cbu As String = nvUtiles.obtenerValor({"cbu", "alias", "cvu"}, "")

        e = servicios.nvQNET.consultarCBUALIAS(cbu)

        If e.params("json_response").getType.name = "nvJSON_String" Then
         json_response("json_response") = e.params("json_response")
        End If
        
        e.params = New trsParam()
        e.params("response") = json_response("json_response")
    ...
    Catch ex As Exception
        ...
        e.debug_src = "Consultar AliasCbuCvu::consultar"
        e.params = New trsParam()
        e.params("response") = json_response("json_response")
