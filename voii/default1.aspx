...
<%
    ...
    ' Provider=ASEOLEDB;Data Source=172.16.5.80:5000;Initial Catalog=DBAnexa;User Id=sa;Password=Impronta15;
    'Stop
    'Dim _rs As ADODB.Recordset = nvFW.nvDBUtiles.DBOpenRecordset("select top 1 * from VOII_prestamos", cod_cn:="BD_IBS_ANEXA")
 %>
...
<head>
    ...
    <script  type="text/javascript" >
        ...
        function abrir_ventana_emergente(path, descripcion, permiso, nro_permiso, height, width)
        {
...
<body onload="window_onload()" onresize='window_onresize()' style="overflow: hidden;">
    ...
    <table id="tb_body" cellpadding="0" cellspacing="0" border="0" style="width: 100%; height: 100%;">
        <tr>
            <td>
                <iframe src="enBlanco.htm" name="frame_ref" id="frame_ref" style="width: 100%; height: 100%;" frameborder="0" marginheight="0" marginwidth="0"></iframe>
            </td>
        </tr>
    </table>
    ...
    <script type="text/javascript">
        ...
        vMenu.loadImage('permiso',      '/voii/image/icons/sesion_cerrar.png')
        ...
        vMenu.loadImage('seguridad',    '/voii/image/icons/sesion_cerrar.png')
        ...
        //var strXML = DocumentMNG.GetDocumentXML('DocMNG','GetMenuItems', 'voii_mnu_cabecera')
