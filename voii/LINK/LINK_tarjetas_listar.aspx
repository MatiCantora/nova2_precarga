...
<body onload="window_onload()" onresize="window_onresize()" style="width: 100%; height: 100%; overflow: hidden;">
    ...
    <div id="divSelectBuscar">
        <table class="tb1">
            <tr>
                <td class="Tit1" style="width: 20%; text-align: right;">Tipo de Búsqueda:&nbsp;</td>
                <td>
    ...
    <div id="divCabecera" class="cabecera">
        <div class="cabecera_content">
            ...
            <table id="tbCabeceraTarjeta" class="tb1">
                <tr class="tbLabel">
                    <%--Tarjeta--%>
                    <td style="text-align: center; width:20%" nowrap>Codigo Transacción</td>
                    ...
                    <td style="text-align: center; width:15%" colspan="2" nowrap>Fecha Emisión</td>
