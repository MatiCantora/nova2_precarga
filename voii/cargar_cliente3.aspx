...
<%
    ...
    If (strXML <> "") Then
        ...
        Dim err As New tError
        err.params("nro_entidad") = nvServer.nro_entidad_shared
        err.response()
    End If
    ...
    If tipdoc > 0 And nrodoc > 0 Or nro_entidad > 0 Then
        ...
        Me.contents("filtro_vinculos") = nvFW.nvXMLSQL.encXMLSQL("<criterio><select vista='VOII_entidad_vinculos' cn='BD_IBS_ANEXA'><campos>vinc_razon_social, vinc_tipocli, " +
                                                                 ...
                                                                 "cliclivincod, vincliclinom, tipvinclidesc, clivinfecalta, clivinfecven</campos>" +
    ...
    <script type="text/javascript">
            ...
            if (nvFW.pageContents.entXML) {
                ...
                rs.onComplete = function (rs) {
                    if (!rs.eof()) {
                        ...
                        $$('#verClienteSelf')[0].onclick = function (event) { verEntidad(event, nvFW.pageContents.nro_entidad, rs.getdata("tipdoc"), rs.getdata("nrodoc"), rs.getdata("tipocli"), rs.getdata("razon_social")); };
                    }
        ...
        function verEntidad(evento, nro_entidad, tipdoc, nrodoc, tipocli, nombre) {
            ...
            if (nro_entidad > 0) {
                ...
                url_destino += "?tipdoc=" + tipo_docu_ibs + "&nrodoc=" + nrodoc + "&tipocli=" + tipocli + "&titulo=" + nombre
            }
