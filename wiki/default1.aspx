...
<head>
    ...
    <script type="text/javascript">
        ...
        function abrir_ventana_emergente_OnClose() {
            ...
            var nro_ref = window.top.win.options.userData
        ...
        function ver_info_operador() {
            ver = nvFW.createWindow({
                url: '../../rrhh/ver_info_operador.aspx',
    ...
    <table id="tb_cab" cellspacing="0" border="0" cellpadding="0" style="width: 100%; height: 64px">
        <tr>
            <td rowspan="2" id="logo_rm" style="WIDTH: 424px; HEIGHT: 64px">
                <object style="WIDTH: 140px; HEIGHT: 64px" data="/wiki/image/cabecera/Logo_Nova_Inicio_wiki.svg" type="image/svg+xml">
                </object>
            </td>
            <td>
