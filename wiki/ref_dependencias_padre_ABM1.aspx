...
<%
    ...
    Dim gethijo = nvFW.nvUtiles.obtenerValor("gethijo", "")
    Dim nro_ref_hijo = nvFW.nvUtiles.obtenerValor("nro_ref_hijo_txt", "")
    ...
    If (modo.ToUpper() = "M") Then
        ...
        Try
            ...
            For i As Integer = 0 To objXML.selectNodes("referencia_dependencia/ref_dependencias").length - 1
                ...
                nod.selectSingleNode("@nro_ref_padre").nodeValue
                nod.selectSingleNode("@ref_dep_orden").nodeValue
                strSQL += "insert into ref_dependencias(nro_ref, nro_ref_padre, ref_dep_orden) values (" + nro_ref_hijo + ", " + nod.attributes(0).nodeValue + ", " + nod.attributes(1).nodeValue + ")\n"
            Next
...
<head>
    ...
    <script type="text/javascript">
        ...
        var vButtonItems = {},
            filtro_ref_padre_permiso = '<%= filtro_ref_padre_permiso%>'
