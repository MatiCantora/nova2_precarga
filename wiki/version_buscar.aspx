    ...
    <script type="text/javascript">
        ...
        function buscar_versiones() 
        {
            ...
            nvFW.exportarReporte({
                ...
                path_xsl: "report\\verRef_docs\\verRef_doc_versiones\\HTML_ref_doc_versiones.xsl",
        ...
        function version_cargar(ref_doc_version, nro_ref_doc, nro_ref) {
            ...
            nvFW.exportarReporte({
                ...
                nvFW_mantener_origen: true,
                id_exp_origen: 0,
                parametros: '<parametros><id_ref_auto>' + window.top.id_ref_auto + '</id_ref_auto><app_path_rel>' + window.top.app_path_rel + '</app_path_rel><permisos_referencias>' + window.top.permiso_grupos["permisos_referencias"] + '</permisos_referencias></parametros>'
            })
        }
