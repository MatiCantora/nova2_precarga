...
<%
    ...
    Dim footerText As String = "Página [page] de [topage]"
...
<head>
    ...
    <body onload="return window_onload()" onresize="window_onresize()" style="width:100%;height: 100%; overflow: auto; background: #FFFFFF;">
        <table class="tb1" id="tb_exportar" style="width: 100%; border-radius:0;">
            ...
            <tr>
                <td class="tit1" style="width:50%; text-align:right;">Tamaño de página:</td>
                <td style="width:50%;">
                    <select id="pageSize">
            ...
            <tr>
                <td class="tit1" style="width:50%; text-align:right;">Tamaño de Fuente del Footer:</td>
                <td style="width:50%;"><input id="footerFontSize" type="number" value="<%= footerFontSize%>"/></td>
            </tr>
            <tr>
                <td class="tit1" style="width:50%; text-align:right;">Texto del pie de página</td>
