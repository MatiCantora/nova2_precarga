...
<%
    ...
    Dim getpadre As String = nvFW.nvUtiles.obtenerValor("getpadre", "")
    Dim nro_ref_padre As String = nvFW.nvUtiles.obtenerValor("nro_ref_padre_txt", "")
    ...
    If modo.ToUpper() = "M" Then
        ...
        Try
            ...
            For Each nod As System.Xml.XmlNode In nodes
                strSQL += "insert into ref_dependencias(nro_ref, nro_ref_padre, ref_dep_orden) values (" + nod.Attributes("nro_ref").Value + ", " + nro_ref_padre + ", " + nod.Attributes("ref_dep_orden").Value + ")\n"
            Next
...
<head>
    ...
    <script type="text/javascript" >
        ...
        var s_getpadre = nvFW.pageContents.getpadre
