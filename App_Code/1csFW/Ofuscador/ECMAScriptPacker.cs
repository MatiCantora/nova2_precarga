...
namespace Dean.Edwards
{
    ...
    {
        public static string strRegAjustaPuntoYcoma = "([a-z|0-9|_'\"\\.\\]]{1})(\\s*)\\n(\\s*)([a-z|0-9|_$$\\)]{1})";
        public static string reemplazoAjustaPuntoYcoma = "$1;$2\n$3$4";
        ...
        private string basicCompression(string script)
        {
            ...
            Yahoo.Yui.Compressor.JavaScriptCompressor jsc = new Yahoo.Yui.Compressor.JavaScriptCompressor();
            return jsc.Compress(script);

            //Regex reg = new Regex(strRegAjustaPuntoYcoma);
            //script = reg.Replace(script, reemplazoAjustaPuntoYcoma);
            //return script;
